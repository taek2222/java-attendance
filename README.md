...
- [ ] 날짜에 해당하는 출석의 시간을 변경
- [ ] 교육 시간은 월요일은 13:00-18:00, 화요일-금요일은 10:00-18:00 (주말 공휴일 출석x)
  - 5분 초과는 지각
  - 30분 초과는 결석
  - 출석 기록이 없는 날은 결석
- [ ] 캠퍼스 운영 시간은 08:00~23:00
...
- [ ] 닉네임에 해당하는 출석/지각/결석 횟수 종합

### 출결 위험도 판단

- [ ] 수강생이 출결 위험도 대상자인지 확인
- [ ] 누적 지각 및 결석 횟수에 따라 경고 또는 면담을 시행 (지각 3회는 결석 1회)
  - 경고 대상자: 결석 2회 이상
  - 면담 대상자: 결석 3회 이상
  - 제적 대상자: 결석 5회 초과
